...
const hemiphereLight = new THREE.HemisphereLight(0xff0, 0x0000FF, 0.5)
scene.add(hemiphereLight)
gui.add(hemiphereLight, 'intensity').min(0).max(1).step(0.001)
...
//helpers
const hemisphereLightHelper = new THREE.HemisphereLightHelper(hemiphereLight, 0.2)
...
const spotLight = new THREE.SpotLight(0xff0, 0.5)
